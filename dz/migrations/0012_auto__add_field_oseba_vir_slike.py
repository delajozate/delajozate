...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Oseba.vir_slike'
        db.add_column('dz_oseba', 'vir_slike', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
        for oseba in orm.Oseba.objects.all():
            if oseba.slika:
                oseba.vir_slike = 'www.dz-rs.si'
                oseba.save()

    def backwards(self, orm):
        
        # Deleting field 'Oseba.vir_slike'
        db.delete_column('dz_oseba', 'vir_slike')
