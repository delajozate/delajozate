...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Seja.slug'
        db.add_column('magnetogrami_seja', 'slug', self.gf('django.db.models.fields.CharField')(default='-', max_length=100, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Seja.slug'
        db.delete_column('magnetogrami_seja', 'slug')
