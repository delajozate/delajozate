...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Glas.poslanec'
        db.add_column('magnetogrami_glas', 'poslanec', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Glas.poslanec'
        db.delete_column('magnetogrami_glas', 'poslanec')
