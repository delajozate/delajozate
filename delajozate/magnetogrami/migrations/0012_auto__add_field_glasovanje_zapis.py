...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Glasovanje.zapis'
        db.add_column('magnetogrami_glasovanje', 'zapis', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['magnetogrami.Zapis'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Glasovanje.zapis'
        db.delete_column('magnetogrami_glasovanje', 'zapis_id')
