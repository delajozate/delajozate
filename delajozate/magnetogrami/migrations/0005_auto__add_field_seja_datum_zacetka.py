...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Seja.datum_zacetka'
        db.add_column('magnetogrami_seja', 'datum_zacetka', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Seja.datum_zacetka'
        db.delete_column('magnetogrami_seja', 'datum_zacetka')
    ...
    models = {
        ...
        'magnetogrami.seja': {
            'Meta': {'ordering': "('-datum_zacetka',)", 'object_name': 'Seja'},
