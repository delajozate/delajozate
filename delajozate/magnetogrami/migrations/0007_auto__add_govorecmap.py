...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GovorecMap'
        db.create_table('magnetogrami_govorecmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('govorec', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('oseba', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dz.Oseba'])),
        ))
        db.send_create_signal('magnetogrami', ['GovorecMap'])


    def backwards(self, orm):
        
        # Deleting model 'GovorecMap'
        db.delete_table('magnetogrami_govorecmap')
    ...
    models = {
        ...
        'magnetogrami.govorecmap': {
            ...
            'govorec': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
