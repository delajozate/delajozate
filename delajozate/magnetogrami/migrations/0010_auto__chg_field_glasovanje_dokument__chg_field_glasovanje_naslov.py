...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Glasovanje.dokument'
        db.alter_column('magnetogrami_glasovanje', 'dokument', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

        # Changing field 'Glasovanje.naslov'
        db.alter_column('magnetogrami_glasovanje', 'naslov', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))


    def backwards(self, orm):
        
        # Changing field 'Glasovanje.dokument'
        db.alter_column('magnetogrami_glasovanje', 'dokument', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Glasovanje.naslov'
        db.alter_column('magnetogrami_glasovanje', 'naslov', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
