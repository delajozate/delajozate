...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.zasedanje'
        db.add_column('magnetogrami_video', 'zasedanje', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magnetogrami.Zasedanje'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.zasedanje'
        db.delete_column('magnetogrami_video', 'zasedanje_id')
    ...
    models = {
        ...
        'magnetogrami.video': {
            ...
            'zasedanje': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['magnetogrami.Zasedanje']", 'null': 'True'})
        },
        'magnetogrami.zapis': {
