...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Seja.delovno_telo'
        db.add_column('magnetogrami_seja', 'delovno_telo', self.gf('django.db.models.fields.CharField')(default='dz', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Seja.delovno_telo'
        db.delete_column('magnetogrami_seja', 'delovno_telo')
