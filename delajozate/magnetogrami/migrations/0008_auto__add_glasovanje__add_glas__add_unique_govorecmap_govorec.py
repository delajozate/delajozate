...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Glasovanje'
        db.create_table('magnetogrami_glasovanje', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seja', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magnetogrami.Seja'], null=True)),
            ('ura', self.gf('django.db.models.fields.TimeField')(null=True)),
            ...
            ('dokument', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('naslov', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('faza_postopka', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
        ))
        db.send_create_signal('magnetogrami', ['Glasovanje'])

        # Adding model 'Glas'
        db.create_table('magnetogrami_glas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('glasovanje', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['magnetogrami.Glasovanje'], null=True)),
            ('oseba', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dz.Oseba'], null=True)),
            ('kvorum', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('glasoval', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('magnetogrami', ['Glas'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Glasovanje'
        db.delete_table('magnetogrami_glasovanje')

        # Deleting model 'Glas'
        db.delete_table('magnetogrami_glas')
    ...
    models = {
        ...
        'magnetogrami.glasovanje': {
            ...
            'dokument': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            ...
            'ura': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
