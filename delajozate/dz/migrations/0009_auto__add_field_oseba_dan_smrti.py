...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Oseba.dan_smrti'
        db.add_column('dz_oseba', 'dan_smrti', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Oseba.dan_smrti'
        db.delete_column('dz_oseba', 'dan_smrti')
