...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('dz_odbor', 'dz_delovnotelo')

        # Changing field 'ClanOdbora.odbor'
        db.alter_column('dz_clanodbora', 'odbor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dz.DelovnoTelo']))


    def backwards(self, orm):
        
        db.rename_table('dz_delovnotelo', 'dz_odbor')
        
        # Changing field 'ClanOdbora.odbor'
        db.alter_column('dz_clanodbora', 'odbor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dz.Odbor']))
