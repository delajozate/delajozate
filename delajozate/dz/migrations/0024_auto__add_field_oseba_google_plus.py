...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Oseba.google_plus'
        db.add_column('dz_oseba', 'google_plus', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Oseba.google_plus'
        db.delete_column('dz_oseba', 'google_plus')
    ...
    models = {
        ...
        'dz.oseba': {
            ...
            'google_plus': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
