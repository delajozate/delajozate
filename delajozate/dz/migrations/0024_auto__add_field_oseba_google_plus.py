...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dz_oseba', 'google_plus', self.gf('django.db.models.fields.BigIntegerField')(null=True), keep_default=False)
    ...
    models = {
        ...
        'dz.oseba': {
            ...
            'google_plus': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
