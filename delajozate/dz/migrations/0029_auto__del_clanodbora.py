...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('dz_clanodbora', (
            ...
            ('odbor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dz.DelovnoTelo'])),
            ...
            ('poslanec', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dz.Funkcija'])),
        ))
