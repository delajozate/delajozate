...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Funkcija'
        db.delete_table('dz_funkcija')


    def backwards(self, orm):
        
        # Adding model 'Funkcija'
        db.create_table('dz_funkcija', (
            ...
            ('funkcija', self.gf('django.db.models.fields.CharField')(default='poslanec', max_length=64)),
        ...
        db.send_create_signal('dz', ['Funkcija'])
