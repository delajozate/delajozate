...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Oseba.podatki_preverjeni'
        db.add_column('dz_oseba', 'podatki_preverjeni', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Oseba.opombe'
        db.add_column('dz_oseba', 'opombe', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Oseba.podatki_preverjeni'
        db.delete_column('dz_oseba', 'podatki_preverjeni')

        # Deleting field 'Oseba.opombe'
        db.delete_column('dz_oseba', 'opombe')
