...
class Migration(DataMigration):
	def forwards(self, orm):
		for f in orm.ClanOdbora.objects.all():
			orm.Pozicija.objects.create(**{
				'oseba': f.poslanec.oseba,
				'organizacija': f.odbor.organizacija,
				'tip': 'clan',
				'od': f.od,
				'do': f.do,
	...
	def backwards(self, orm):
		orm.Pozicija.objects.filter(organizacija__odbor__gt=0).delete()
