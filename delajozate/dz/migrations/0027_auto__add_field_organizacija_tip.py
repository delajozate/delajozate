...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organizacija.tip'
        db.add_column('dz_organizacija', 'tip', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
        
        from django.core.exceptions import ObjectDoesNotExist
        for org in orm.Organizacija.objects.all():
            n = 1
            for k in ['stranka', 'skupina', 'drzavnizbor', 'delovnotelo']:
                try:
                    getattr(org, k)
                    org.tip = n
                    org.save()
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Organizacija.tip'
        db.delete_column('dz_organizacija', 'tip')
